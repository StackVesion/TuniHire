                    ...
                    <ul className="main-menu">
                        ...
                        {user && user.role && user.role.toString().toUpperCase() === 'CANDIDATE' && (
                            <>
                                ...
                                <li><Link className={router.pathname === "/apply-for-jobs" ? "dashboard2 active" : "dashboard2"} href="/apply-for-jobs"><img src="assets/imgs/page/dashboard/recruitment.svg" alt="jobBox" /><span className="name">Apply for Job</span></Link></li>
