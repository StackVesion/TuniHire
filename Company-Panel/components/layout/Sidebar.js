                    ...
                    <ul className="main-menu">
                        ...
                        {user && user.role && user.role.toString().toUpperCase() === 'HR' && (
                            <>
                                ...
                                <li><Link className={router.pathname === "/meetings" ? "dashboard2 active" : "dashboard2"} href="/meetings"><img src="/assets/imgs/page/dashboard/calendar.svg" alt="jobBox" /><span className="name">Meetings</span></Link></li>
