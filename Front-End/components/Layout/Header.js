    ...
    useEffect(() => {
        ...
        if (token && storedUser) {
            try {
                ...
                if (parsedUser && parsedUser.email) {  // Basic validation
                    setUser(parsedUser);
                            ...
                            <div className="block-signin">
                                {user ? (
                                    <div className="user-info">
                                        <span className="user-name mr-15">{user.firstName} {user.lastName}</span>
                                        <button onClick={handleLogout} className="btn btn-default btn-shadow hover-up">Logout</button>
                                    </div>
                                ) : (
                                    <>
